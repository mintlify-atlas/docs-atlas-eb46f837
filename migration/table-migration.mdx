...
![In-Place Metadata Migration](/images/iceberg-in-place-metadata-migration.png)
...
<Steps>
  <Step title="Create new Iceberg table">
    ...
    ![Snapshot Table Step 1](/images/iceberg-snapshotaction-step1.png)
  </Step>
  ...
  <Step title="Commit data files">
    ...
    ![Snapshot Table Step 2](/images/iceberg-snapshotaction-step2.png)
  </Step>
...
<Steps>
  <Step title="Stop all writers">
    ...
    ![Migrate Table Step 1](/images/iceberg-migrateaction-step1.png)
  </Step>
  ...
  <Step title="Create new table and rename source">
    ...
    ![Migrate Table Step 2](/images/iceberg-migrateaction-step2.png)
  </Step>
  ...
  <Step title="Commit files and drop source">
    ...
    ![Migrate Table Step 3](/images/iceberg-migrateaction-step3.png)
  </Step>
</Steps>
