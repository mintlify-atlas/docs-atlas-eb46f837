...
See [Catalog Properties](/configuration/catalog-properties) for a full list.
...
- [Catalog Properties](/configuration/catalog-properties) - Complete property reference
- [OAuth2 Authentication](/security/oauth2) - Authentication configuration
