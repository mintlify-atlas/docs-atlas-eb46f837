...
- [Catalog Configuration](/configuration/catalog-properties) - Catalog configuration properties
- [Table Metadata](/spec/table-metadata) - Table metadata format
- [View Metadata](/spec/view-metadata) - View metadata format
- [OAuth2 Integration](/security/oauth2) - Authentication setup
