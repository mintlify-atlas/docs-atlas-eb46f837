...
- [Puffin File Format](/formats/puffin) - Statistics file format specification
- [Query Optimization](/concepts/query-optimization) - How statistics improve queries
- [Table Metadata](/concepts/metadata) - Understanding table metadata structure
