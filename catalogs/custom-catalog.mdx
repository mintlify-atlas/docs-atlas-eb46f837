...
<Note>
To work with encrypted tables, custom catalogs must address specific [security requirements](/security/encryption#catalog-requirements).
</Note>
...
- [JdbcCatalog](~/workspace/source/core/src/main/java/org/apache/iceberg/jdbc/JdbcCatalog.java) - Relational database catalog
- [HadoopCatalog](~/workspace/source/core/src/main/java/org/apache/iceberg/hadoop/HadoopCatalog.java) - File system catalog
- [GlueCatalog](~/workspace/source/aws/src/main/java/org/apache/iceberg/aws/glue/GlueCatalog.java) - AWS Glue integration
