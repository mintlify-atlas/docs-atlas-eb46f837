...
<CardGroup cols={2}>
  <Card title="Hive Metastore" icon="database" href="/catalogs/hive">
    Use existing Hive metastore infrastructure
  </Card>
  
  <Card title="AWS Glue" icon="aws" href="/catalogs/glue">
  ...
  <Card title="REST" icon="server" href="/catalogs/rest">
    Language-agnostic REST catalog service
  </Card>
  
  <Card title="Hadoop" icon="folder" href="/catalogs/hadoop">
...
See the [Encryption documentation](/security/encryption) for detailed requirements.
...
<CardGroup cols={2}>
  ...
  <Card title="Storage Configuration" icon="hard-drive" href="/storage/overview">
